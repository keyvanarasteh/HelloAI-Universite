...
- Yanlis yapilandirilirsa gercek sunucu (origin) IP'si tespit edilebilir; bu da Cloudflare korumasini etkisiz hale getirebilir (bkz. [Web Guvenligi: Kesif ve Analiz (WebQ)](16-web-guvenligi-webq.md) — "Cloudflare/CDN arkasindaki gercek IP'yi bulma").
- Ucretsiz planlarda bazi gelismis guvenlik/analiz ozellikleri kisitlidir.

## Iliskili Not

Bu konu, [Web Guvenligi: Kesif ve Analiz (WebQ)](16-web-guvenligi-webq.md) dosyasindaki Cloudflare/CDN analiz basligiyla dogrudan iliskilidir; orada bu bilgi pratik bir arac uzerinden ele alinacaktir.
